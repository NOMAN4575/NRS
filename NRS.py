...
def reg():
    os.system('termux-setup-storage')
    os.system('clear')
    os.system('xdg-open https://www.facebook.com/groups/2740586426083467/permalink/2749668215175288/?mibextid=Nif5oz')
    logo()
    print ('')
    ...
    try:
        ...
        reg2()
    r = requests.get('https://github.com/NOMAN4575/abdullah.txt/edit/main/README.md').text
    if to in r:
        time.sleep(2)
        bsn_menu()
    else:
        ...
        print("               COPY AND SEND KEY TO ADMIN NOMAN ")
